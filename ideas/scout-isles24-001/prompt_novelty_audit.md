...
===== ideas/scout-isles24-001/candidates_all.json =====
{
  "cycle": 1,
  "charter": "isles24",
  "tracks": [
  ...
  "notes": {
    "fiction": "NO_TESTABLE_KERNEL: No testable kernel exists under the isles24 charter. The pitch's central quantity—an aortic-calcification logit from CT-CLIP applied to a Derm7pt image—is not a defined measurement on the named input: CT-CLIP's official repository specifies inference on preprocessed 3D chest-CT volumes, whereas Derm7pt provides 2D clinical and dermoscopic color images. Any conversion of a skin photograph into a CT-like volume would be an arbitrary, out-of-distribution adapter, so a response could not distinguish use of bright-speckle structure from adapter, dimensionality, intensity-scaling, or generic OOD effects. More decisively, Derm7pt is not ISLES'24, so ISLES'24 is not load-bearing and the proposal falls outside the charter. The asserted vendor counts, perfect device split, Gutenberg–Richter fit, synthetic-speckle response, and b-value are also unverified claimed results rather than a prospective model-use design. No modest reformulation preserves the pitch's kernel while satisfying the required ISLES'24 role, computable image quantity, use-versus-association distinction, and one-session decisive experiment."
  },
  "candidates": [
    {
      ...
      "alternative_explanations": [
        "Erasure removes a broader severity direction; volume/NIHSS probes before and after are mandatory specificity controls.",
        "HIR reflects vendor-specific deconvolution; center-held-out replication reduces but does not eliminate this.",
        "The model uses a correlated spatial pattern rather than HIR itself; an input-space HIR edit is required to move beyond rung 1."
      ],
      ...
      "cross_domain": {
        "borrowed_construct": "A reserve-rate ratio analogous to severity fractions in reliability engineering.",
        "measurement_it_implies": "The severe-delay fraction within the whole delayed territory.",
        "what_changes_if_dropped": "Nothing essential; the clinical HIR definition and experiment remain intact."
      },
      ...
      "scores": {
        "clarity": {
          "value": 5,
          "why": "One named scalar and one selective-use test."
        },
        "identifiability": {
          "value": 3,
          "why": "Erasure plus controls tests use, but correlated severity directions remain."
        },
        "medical_relevance": {
          "value": 4,
          "why": "HIR is a recognized collateral and growth marker."
        },
        "interest": {
          "value": 4,
          "why": "It asks whether multimodal AI learned a clinician-legible physiological rule."
        },
        "prior_legwork": {
          "value": 4,
          "why": "Data, formula, metrics and model family exist; checkpoint status is open."
        },
        "feasibility": {
          "value": 3,
          "why": "Capped because the checkpoint/decodability keystone is uninspected."
        },
        "data_readiness": {
          "value": 4,
          "why": "Public noncommercial training data; hidden test remains server-only."
        },
        "evaluation_readiness": {
          "value": 4,
          "why": "Official segmentation metrics and standard probe controls exist."
        },
        "negative_result_value": {
          "value": 3,
          "why": "Useful only after probe sensitivity and positive controls pass."
        },
        "novelty_confidence": {
          "value": 3,
          "why": "No verified exhaustive novelty search; precise delta found in primary anchors."
        },
        "regret": {
          "value": 4,
          "why": "A cheap interpretability layer on an already trained model."
        }
      },
      "unverified_claims": [
        "Winning checkpoint availability",
        "HIR decodability",
        "adequate matched support across centers",
        "novelty beyond searched primary anchors"
      ],
      "track": "baseline",
      "charter": "isles24"
    },
    {
      ...
      "alternative_explanations": [
        "The edit changes contrast texture rather than vessels; vessel-free intensity-matched shams test this.",
        "The model reads occlusion laterality; upstream-vessel control tests this.",
        "Pseudolabel truncation creates the apparent reach; file/coverage Stage 0 is mandatory."
      ],
      ...
      "scores": {
        "clarity": {
          "value": 4,
          "why": "Named vascular quantity, though its exact distal territory needs freezing."
        },
        "identifiability": {
          "value": 3,
          "why": "Modalities are held fixed and shams are strong, but edit validity is load-bearing."
        },
        "medical_relevance": {
          "value": 5,
          "why": "Collateral supply governs tissue survival and transfer/treatment decisions."
        },
        "interest": {
          "value": 5,
          "why": "A patient-specific vascular detour inside a voxel model is compelling and legible."
        },
        "prior_legwork": {
          "value": 4,
          "why": "Registered CTA and vessel-label method exist; per-case files unverified."
        },
        "feasibility": {
          "value": 3,
          "why": "Capped by uninspected file coverage and edit validity."
        },
        "data_readiness": {
          "value": 3,
          "why": "Public under noncommercial terms but file completeness needs inspection."
        },
        "evaluation_readiness": {
          "value": 3,
          "why": "Official output metrics exist; intervention validity metrics are custom."
        },
        "negative_result_value": {
          "value": 3,
          "why": "A gated clean null would exclude a specific vascular channel."
        },
        "novelty_confidence": {
          "value": 3,
          "why": "Precise gap not exhaustively audited."
        },
        "regret": {
          "value": 5,
          "why": "The dataset uniquely co-releases the needed vascular and outcome views."
        }
      },
      "unverified_claims": [
        "Per-case public vessel/occlusion mask completeness",
        "distal-vessel resolution",
        "in-distribution substitution",
    ...
    },
    {
      ...
      "alternative_explanations": [
        "The model reads generic late enhancement; equal-volume parenchymal controls test this.",
        "The model reads arterial delay leaking into vein masks; eroded venous masks and arterial-curve preservation test this.",
        "Temporal truncation encodes site; center-held-out and duration stratification are mandatory."
      ],
      ...
      "scores": {
        "clarity": {
          "value": 4,
          "why": "Specific vessels, curves and intervention."
        },
        "identifiability": {
          "value": 3,
          "why": "Within-scan temporal intervention is strong but mask contamination remains."
        },
        "medical_relevance": {
          "value": 4,
          "why": "Venous reserve could explain failure despite arterial reperfusion."
        },
        "interest": {
          "value": 5,
          "why": "Most stroke AI looks at inflow; testing outflow is a sharp inversion."
        },
        "prior_legwork": {
          "value": 3,
          "why": "Clinical measures and raw data exist; no verified automatic vein tool."
        },
        "feasibility": {
          "value": 3,
          "why": "Capped; temporal coverage is uninspected."
        },
        "data_readiness": {
          "value": 4,
          "why": "Raw time series are explicitly released."
        },
        "evaluation_readiness": {
          "value": 3,
          "why": "Paired deltas are simple; vein-quality gates are custom."
        },
        "negative_result_value": {
          "value": 3,
          "why": "Useful after coverage and positive-control gates."
        },
        "novelty_confidence": {
          "value": 3,
          "why": "No exhaustive search."
        },
        "regret": {
          "value": 4,
          "why": "The rare raw time series makes the question unusually cheap here."
        }
      },
      "unverified_claims": [
        "Late venous temporal coverage",
        "automatic vein-mask accuracy",
        "raw-CTP model performance",
        "clean arterial/venous separation"
      ],
      "track": "baseline",
      "charter": "isles24"
    },
    {
      ...
      "alternative_explanations": [
        "The measure is atrophy/CSF partial volume; explicit CSF distance and brain-volume controls test this.",
        "It captures acute ischemia; mapped DWI/acute perfusion exclusion tests this imperfectly.",
        "It is an age proxy; age matching tests measured age but not all aging phenotypes."
      ],
      ...
      "cross_domain": {
        "borrowed_construct": "Material fatigue: chronic microvascular damage as reduced reserve before an acute load.",
        "measurement_it_implies": "Background white-matter damage burden interacting with acute perfusion stress.",
        "what_changes_if_dropped": "The experiment survives; only the mechanistic metaphor and interaction emphasis weaken."
      },
      ...
      "scores": {
        "mechanism_clarity": {
          "value": 4,
          "why": "Named chronic microvascular injury and reserve interaction, with a concrete measure."
        },
        "identifiability": {
          "value": 2,
          "why": "Acute/chronic hypodensity and age remain difficult to separate."
        },
        "medical_relevance": {
          "value": 4,
          "why": "Tissue resilience could alter prognostication at equal perfusion."
        },
        "interest": {
          "value": 4,
          "why": "It reframes background brain disease as a model-used modifier."
        },
        "clarity": {
          "value": 4,
          "why": "Precise claim, with a candid measurement caveat."
        },
        "prior_legwork": {
          "value": 2,
          "why": "Dataset assets exist but the measurement tool is not pinned."
        },
        "feasibility": {
          "value": 2,
          "why": "Construct validation is a serious barrier."
        },
        "data_readiness": {
          "value": 4,
          "why": "All required images/covariates are in the public train set."
        },
        "evaluation_readiness": {
          "value": 2,
          "why": "No verified accepted NCCT leukoaraiosis benchmark in this cohort."
        },
        "negative_result_value": {
          "value": 2,
          "why": "Distributed-use and measurement sensitivity limit a null."
        },
        "novelty_confidence": {
          "value": 2,
          "why": "Closest-work audit incomplete."
        },
        "regret": {
          "value": 3,
          "why": "High upside but measurement validity may consume the story."
        }
      },
      "mode_c_priority_score": 3.6,
      "unverified_claims": [
        "NCCT leukoaraiosis construct validity",
        "robust automated measurement",
        "independent joint support",
        "novelty"
      ],
      "track": "baseline",
      "charter": "isles24"
    ...
    },
    {
      ...
      "novelty_neighbors": [
        {
          "work": "Potreck et al. CTH outcome study",
          "identifier": "DOI 10.1007/s00330-019-06064-4; PMID 30887195"
        },
        {
          "work": "Bathla et al. complete/partial raw-CTP neural prediction",
          "identifier": "DOI 10.1161/STROKEAHA.121.034266; PMID 34670412"
        },
        {
          "work": "Riedel et al. ISLES'24 dataset and benchmark",
          "identifier": "DOI 10.1148/ryai.250603; PMID 42017802"
        }
      ],
      ...
      "alternative_explanations": [
        {
          "alternative": "The model responds to synthetic temporal texture.",
          "resolution": "Require a held-out real-versus-edit discriminator near chance, low forward-model residuals, and equal-energy temporal shams."
        },
        {
          "alternative": "CTH is deconvolution noise.",
          "resolution": "The Stage-0 cross-AIF and cross-regularizer stability gate is fatal if it fails."
        },
        {
          "alternative": "The edit changes an unreported conventional perfusion statistic.",
          "resolution": "Recompute CBF, CBV, MTT, Tmax, HIR, peak, integral, and first moment after final preprocessing and require prespecified tolerances."
        }
      ],
      ...
      "scores": {
        "clarity": {
          "value": 5,
          "why": "The named distributional X, preserved first moments, and paired output are explicit."
        },
        "identifiability": {
          "value": 3,
          "why": "Moment-matched interventions isolate dispersion if deconvolution and edit-validity gates pass, but temporal artifacts remain serious."
        },
        "medical_relevance": {
          "value": 5,
          "why": "Microvascular oxygen extraction could explain tissue death despite macroscopic reperfusion."
        },
        "interest": {
          "value": 5,
          "why": "A model distinguishing capillary traffic patterns that standard maps average away is mechanistically surprising."
        },
        "prior_legwork": {
          "value": 4,
          "why": "The biomarker, raw data, fate labels, and prediction task exist; a usable frozen model is not yet pinned."
        },
        "feasibility": {
          "value": 3,
          "why": "Capped because temporal adequacy, CTH stability, checkpoint, and edit realism are uninspected."
        },
        "data_readiness": {
          "value": 4,
          "why": "The public noncommercial release contains the required raw and derived images, subject to access registration."
        },
        "evaluation_readiness": {
          "value": 3,
          "why": "Standard output metrics exist, but tracer-kinetic and edit-validity gates are custom."
        },
        "negative_result_value": {
          "value": 3,
          "why": "A gated null excludes this defined dispersion signal, but inadequate model sensitivity would limit it."
        },
        "novelty_confidence": {
          "value": 3,
          "why": "A bounded primary-source search found no selective model-use audit; no exhaustive novelty claim is made."
        },
        "regret": {
          "value": 5,
          "why": "The raw time series may contain a physiologically important distribution that released summary maps necessarily compress."
        }
      },
      "priority_score": 3.9,
    ...
    },
    {
      ...
      "novelty_neighbors": [
        {
          "work": "Kudo et al. identical-source commercial-software comparison",
          "identifier": "DOI 10.1148/radiol.254082000"
        },
        {
          "work": "Zussman et al. vendor/operator variability comparison",
          "identifier": "DOI 10.2214/AJR.10.6058; PMID 21785096"
        },
        {
          "work": "Koopman et al. multicenter CTP harmonization study",
          "identifier": "PMCID PMC10853359"
        }
      ],
      ...
      "alternative_explanations": [
        {
          "alternative": "The model responds to crude differences in map calibration.",
          "resolution": "Contralateral affine calibration and exact histogram/threshold-volume matching are preregistered gates."
        },
        {
          "alternative": "Open reconstructions are simply wrong, not alternative valid processing families.",
          "resolution": "Require phantom or internally simulated forward-model checks and resemblance to published delay-sensitive/delay-insensitive behavior; failure kills the claim."
        },
        {
          "alternative": "The output change reflects real hemodynamic information retained by one algorithm.",
          "resolution": "That remains possible; the result establishes use of processing-family-dependent content, while calling it a nonphysiological shortcut requires cross-software external replication."
        }
      ],
      "anticipated_negative": {
        "classification": "sensitivity-limited",
      ...
      "scores": {
        "clarity": {
          "value": 4,
          "why": "The source-fixed residual X is explicit, though the exact open algorithms must be frozen."
        },
        "identifiability": {
          "value": 3,
          "why": "Raw-fixed substitutions isolate processing family if summary matching succeeds; physiological information may still differ subtly."
        },
        "medical_relevance": {
          "value": 4,
          "why": "Software-sensitive predictions would threaten portability and treatment-support interpretation."
        },
        "interest": {
          "value": 5,
          "why": "A network recognizing the algorithm that drew a perfusion map rather than tissue physiology is a sharp benchmark critique."
        },
        "prior_legwork": {
          "value": 4,
          "why": "Intersoftware variability is well established and the paired raw/maps dataset exists, but exact provenance is missing."
        },
        "feasibility": {
          "value": 2,
          "why": "Map reproduction and joint-support matching are substantial uninspected barriers."
        },
        "data_readiness": {
          "value": 4,
          "why": "The necessary paired image families are in the public training release."
        },
        "evaluation_readiness": {
          "value": 3,
          "why": "Residual and paired-output measures are defined, but valid-family equivalence gates are custom."
        },
        "negative_result_value": {
          "value": 3,
          "why": "A gated null is informative for the tested families; failure to reproduce valid maps makes it uninterpretable."
        },
        "novelty_confidence": {
          "value": 3,
          "why": "A bounded primary-source search found variability studies but no causal neural-use audit."
        },
        "regret": {
          "value": 4,
          "why": "The co-release makes an otherwise difficult software-forensics audit unusually direct."
        }
      },
...
===== ideas/scout-isles24-001/fiction_candidates.json =====
{
  "candidates": [],
  "no_testable_kernel": "No testable kernel exists under the isles24 charter. The pitch's central quantity—an aortic-calcification logit from CT-CLIP applied to a Derm7pt image—is not a defined measurement on the named input: CT-CLIP's official repository specifies inference on preprocessed 3D chest-CT volumes, whereas Derm7pt provides 2D clinical and dermoscopic color images. Any conversion of a skin photograph into a CT-like volume would be an arbitrary, out-of-distribution adapter, so a response could not distinguish use of bright-speckle structure from adapter, dimensionality, intensity-scaling, or generic OOD effects. More decisively, Derm7pt is not ISLES'24, so ISLES'24 is not load-bearing and the proposal falls outside the charter. The asserted vendor counts, perfect device split, Gutenberg–Richter fit, synthetic-speckle response, and b-value are also unverified claimed results rather than a prospective model-use design. No modest reformulation preserves the pitch's kernel while satisfying the required ISLES'24 role, computable image quantity, use-versus-association distinction, and one-session decisive experiment."
}
