...
def main():
    ...
    run(['runuser','-u','research-driver','--','codex','sandbox','--','/usr/bin/true'],cwd='/srv/research-system/work')
    ...
    result=run(['runuser','-u','research-driver','--','codex','sandbox','-c','sandbox_mode="workspace-write"','--','/usr/bin/python3','-c',code],cwd=fixture)
