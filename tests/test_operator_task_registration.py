...
class TaskRegistrationTests(unittest.TestCase):
    def test_two_tasks_persist_and_replay_without_execution_or_duplicate_review(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(first['report']['id'],second['report']['id']);self.assertEqual(first['task_count'],2)
